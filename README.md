...
* [runC](https://github.com/opencontainers/runc) ⭐ 13,434 | 🐛 341 | 🌐 Go | 📅 2026-09-04 - CLI tool for spawning and running containers according to the OCI specification.
...
* [systemd](https://github.com/systemd/systemd) ⭐ 16,659 | 🐛 3,415 | 🌐 C | 📅 2026-09-05 - The systemd System and Service Manager.
* [dumb-init](https://github.com/Yelp/dumb-init) ⭐ 7,306 | 🐛 33 | 🌐 Python | 📅 2026-07-13 - A minimal init system for Linux containers.
* [OpenRC](https://github.com/OpenRC/openrc) ⭐ 1,901 | 🐛 220 | 🌐 C | 📅 2026-08-02 - Dependency-based init system that works with the system-provided init program.
...
* [minikube](https://github.com/kubernetes/minikube) ⭐ 32,100 | 🐛 571 | 🌐 Go | 📅 2026-09-05 - minikube implements a local Kubernetes cluster (Linux).
* [microk8s](https://github.com/ubuntu/microk8s) ⭐ 9,364 | 🐛 161 | 🌐 Python | 📅 2026-09-04 - MicroK8s is a small, fast, single-package Kubernetes for developers, IoT and edge (Ubuntu core/server).
