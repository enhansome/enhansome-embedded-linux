...
* [Debos](https://github.com/go-debos/debos) ⭐ 726 | 🐛 128 | 🌐 Go | 📅 2026-08-18 - Debian OS builder.
* [mkroot](https://github.com/landley/mkroot) ⭐ 453 | 🐛 6 | 📅 2024-11-19.
* [Isar](https://github.com/ilbers/isar) ⭐ 249 | 🐛 36 | 🌐 Python | 📅 2026-08-19 - Integration System for Automated Root filesystem generation (Debian).
...
* [runC](https://github.com/opencontainers/runc) ⭐ 13,410 | 🐛 349 | 🌐 Go | 📅 2026-08-20 - CLI tool for spawning and running containers according to the OCI specification.
...
* [metalk8s](https://github.com/scality/metalk8s) ⭐ 393 | 🐛 497 | 🌐 Scheme | 📅 2026-08-19 - An opinionated Kubernetes distribution with a focus on long-term on-prem deployments.
...
* [systemd](https://github.com/systemd/systemd) ⭐ 16,610 | 🐛 3,378 | 🌐 C | 📅 2026-08-20 - The systemd System and Service Manager.
* [dumb-init](https://github.com/Yelp/dumb-init) ⭐ 7,303 | 🐛 33 | 🌐 Python | 📅 2026-07-13 - A minimal init system for Linux containers.
* [OpenRC](https://github.com/OpenRC/openrc) ⭐ 1,894 | 🐛 215 | 🌐 C | 📅 2026-08-02 - Dependency-based init system that works with the system-provided init program.
...
* [minikube](https://github.com/kubernetes/minikube) ⭐ 32,045 | 🐛 550 | 🌐 Go | 📅 2026-08-19 - minikube implements a local Kubernetes cluster (Linux).
* [microk8s](https://github.com/ubuntu/microk8s) ⭐ 9,355 | 🐛 164 | 🌐 Python | 📅 2026-08-19 - MicroK8s is a small, fast, single-package Kubernetes for developers, IoT and edge (Ubuntu core/server).
